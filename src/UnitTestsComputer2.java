...
public class UnitTestsComputer2 {
    ...
    public void write5inR0() {
        ...
        MainMemory.load(new String[] {
                "00000000000000010111100000000001", // math copy 5 R0
    ...
    public void generate512inR6_testMultiply() {
        Processor processor = new Processor();
        MainMemory.load(new String[] {
                "00000000000000001011100001000001", // math copy 2 R2
                "00000000000000011011100001100001", // math copy 6 R3
                "00000000000100001111100010000010", // math add R2 R3 R4
                "00000000001000010001110010100010", // math mult R4 R4 R5
                "00000000001000010101110011000010", // math mult R4 R5 R6
                // halt
    ...
    public void generate13inR13_testSubtract() {
        Processor processor = new Processor();
        MainMemory.load(new String[] {
                "00000000000110010001110110100001", // math copy 100 R13
                "00000000000100011001111111000001", // math copy 70 R30
                "00000000011011111011110110100010", // math sub R13 R30 R13
                "00000000000001000101111111100001", // math copy 17 R31
                "00000000011011111111110110100010", // math sub R13 R31 R13
                // halt
        });
        processor.run();
    ...
    public void generate41045inR20_testAnd() {
        Processor processor = new Processor();
        MainMemory.load(new String[] {
                "01111101000101010111100101000001", // math copy 128085 R10
                "00101010001111011111100000100001", // math copy 43255 R1
                "00000000000010101010001010000010", // math and R1 R10 R20
                // halt
        });
        processor.run();
    ...
    public void generate130295inR20_testOr() {
        ...
        MainMemory.load(new String[] {
                "01111101000101010111100101000001", // math copy 128085 R10
                "00101010001111011111100000100001", // math copy 43255 R1
                "00000000000010101010011010000010", // math or R1 R10 R20
                // halt
        });
        processor.run();
    ...
    public void generate89250inR20_testXor() {
        ...
        MainMemory.load(new String[] {
                "01111101000101010111100101000001", // math copy 128085 R10
                "00101010001111011111100000100001", // math copy 43255 R1
                "00000000000010101010101010000010", // math xor R1 R10 R20
                // halt
        });
        processor.run();
    ...
    public void generateNeg128086inR20_testNot() {
        Processor processor = new Processor();
        MainMemory.load(new String[] {
                "01111101000101010111101010000001", // math copy 128085 R20
                "00000000000000000010111010000011", // math not R20
                // halt
        });
        processor.run();
    ...
    public void generate1024680inR1_testLeftShift() {
        ...
        MainMemory.load(new String[] {
                "01111101000101010111101010000001", // math copy 128085 R20
                "00000000000000001111100001000001", // math copy 3 R2
                "00000000101000001011000000100010", // math lshift R20 R2 R1
                // halt
        });
        processor.run();
    ...
    public void generate16010inR1_testRightShift() {
        ...
        MainMemory.load(new String[] {
                "01111101000101010111101010000001", // math copy 128085 R20
                "00000000000000001111100001000001", // math copy 3 R2
                "00000000101000001011010000100010", // math rshift R20 R2 R1
                // halt
        });
        processor.run();
